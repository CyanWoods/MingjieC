...
void disp_result(int result)        //显示判断结果
{
	switch (result) {
...
*/
void judgement(int result)
{
    switch (result)
    {
        case 0: draw_no++;  puts("平局"); break;
        case 1: lose_no++;  puts("你输"); break;
        case 2: win_no++;   puts("你赢"); break;
    }
}
